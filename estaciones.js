function otoño() {
    ...
    document.getElementById("titulon").style.background = "green";
    document.getElementById("titulon").style.borderColor = "yellow";
...
function invierno() {
    ...
    document.getElementById("titulon").style.background = "pink";
    document.getElementById("titulon").style.borderColor = "blue";    
...
function primavera() {
    ...
    document.getElementById("titulon").style.background = "black";
    document.getElementById("titulon").style.borderColor = "red";
    document.getElementById("moon").style.color = "white";
}
...
function verano() {
    ...
    document.getElementById("titulon").style.borderColor = "violet";
    document.getElementById("texto").style.color = "yellow";
    document.getElementById("moon").style.color = "black";
}

function black() {
    document.getElementById("sobre-mi").style.background = "black";
    document.getElementById("texto").innerHTML = "Puedes cambiar el modo visual";
    document.getElementById("titulon").style.color = "orange";
    document.getElementById("titulon").style.background = "black";
    document.getElementById("titulon").style.borderColor = "black";
    document.getElementById("moon").style.color = "white";
}
